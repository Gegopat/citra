...
#include "citra/configuration/graphics.h"
...
ConfigurationGraphics::ConfigurationGraphics(QWidget* parent)
    : QWidget{parent}, ui{std::make_unique<Ui::ConfigurationGraphics>()} {
    ui->setupUi(this);
...
void ConfigurationGraphics::ApplyConfiguration() {
