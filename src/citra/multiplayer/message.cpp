...
const ConnectionError UNABLE_TO_CONNECT{
    ...
    "you still can't connect, contact the room creator and verify that the host is "
    "properly configured with the external port forwarded."};
const ConnectionError ROOM_IS_FULL{"Unable to connect to the room because it's already full."};
...
const ConnectionError HOST_BANNED{
    "The creator of the room has banned you. Speak with the creator to unban you "
...
const ConnectionError WRONG_VERSION{
    ...
    "persists, contact the room creator and ask them to update the server."};
...
const ConnectionError HOST_KICKED{"You have been kicked by the room creator."};
