...
AM_NET::AM_NET(std::shared_ptr<Module> am) : Module::Interface{std::move(am), "am:net", 5} {
    static const FunctionInfo functions[]{
        ...
        {0x000A0000, &AM_NET::GetDeviceID, "GetDeviceID"},
        ...
        {0x00290082, &AM_NET::DeleteUserProgramsAtomically, "DeleteUserProgramsAtomically"},
        ...
        {0x04120000, &AM_NET::GetSystemUpdaterMutex, "GetSystemUpdaterMutex"},
