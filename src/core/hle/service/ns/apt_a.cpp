...
APT_A::APT_A(std::shared_ptr<Module> apt)
    ...
    static const FunctionInfo functions[]{
        ...
        {0x00340084, &APT_A::SendDeliverArg, "SendDeliverArg"},
        ...
        {0x003C0042, &APT_A::SendDspSleep, "SendDspSleep"},
        {0x003D0042, &APT_A::SendDspWakeUp, "SendDspWakeUp"},
        ...
        {0x00420080, &APT_A::SleepSystem, "SleepSystem"},
