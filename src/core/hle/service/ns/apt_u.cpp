...
APT_U::APT_U(std::shared_ptr<Module> apt)
    ...
    static const FunctionInfo functions[]{
        ...
        {0x00340084, &APT_U::SendDeliverArg, "SendDeliverArg"},
        ...
        {0x003C0042, &APT_U::SendDspSleep, "SendDspSleep"},
        {0x003D0042, &APT_U::SendDspWakeUp, "SendDspWakeUp"},
        ...
        {0x00580002, &APT_U::GetProgramID, "GetProgramID"},
