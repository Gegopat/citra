...
public:
    ...
    public:
        ...
        void DeleteConfigNANDSavefile(Kernel::HLERequestContext& ctx);
        void GetLocalFriendCodeSeedData(Kernel::HLERequestContext& ctx, u16 id);
        void GetLocalFriendCodeSeed(Kernel::HLERequestContext& ctx, u16 id);
        void CreateConfigInfoBlk(Kernel::HLERequestContext& ctx);
        void SetGetLocalFriendCodeSeedData(Kernel::HLERequestContext& ctx);
        void SetLocalFriendCodeSeedSignature(Kernel::HLERequestContext& ctx);
        void DeleteCreateNANDLocalFriendCodeSeed(Kernel::HLERequestContext& ctx);
...
public:
     ...
     * setting is auto.
     * @param region_codes the game preferred region codes
     */
    ...
    /**
     * Sets the system model in config savegame.
     * @param model the model to set.
     */
    void SetSystemModel(SystemModel model);

    /**
     * Gets the system model from config savegame.
